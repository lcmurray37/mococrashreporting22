...
Following this: [Open and Plot Shapefiles -- Introduction to Geospatial Raster and Vector Data with R (datacarpentry.org)](https://datacarpentry.org/r-raster-vector-geospatial/06-vector-open-shapefile-in-r/)
